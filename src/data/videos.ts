...
const clips: Record<string, GalleryVideo> = {
  'aniversare-6': {
    id: 'aniversare-6',
    src: `${CDN}/aniversare-arena-play-6.mp4`,
    label: 'Aniversare la Arena Play',
  },
  'aniversare-2': {
    id: 'aniversare-2',
    src: `${CDN}/aniversare-arena-play-2-web.mp4`,
    label: 'Petrecere cu prietenii',
  },
  'video-1': {
    id: 'video-1',
    src: `${CDN}/arenaplay-video-1.mp4`,
    label: 'Zona de joacă Arena Play',
  },
  'video-2': {
    id: 'video-2',
    src: `${CDN}/arenaplay-video-2.mp4`,
    label: 'Sesiune VR în arena principală',
  },
  'video-5': {
    id: 'video-5',
    src: `${CDN}/arenaplay-video-5.mp4`,
    label: 'Experiență VR la Arena Play',
  },
  'video-6': {
    id: 'video-6',
    src: `${CDN}/arenaplay-video-6.mp4`,
    label: 'Copii în timpul unei sesiuni de joc',
  },
};
 ...
 */
export const galleryVideos = order(
  'aniversare-6',
  'aniversare-2',
  'video-1',
  'video-2',
...
export const playgroundGalleryVideos = order(
  'video-2',
  'video-6',
  'aniversare-6',
  'video-5',
...
export const petreceriGalleryVideos = order(
  'aniversare-2',
  'video-5',
  'video-2',
  'aniversare-6',
...
export const despreNoiGalleryVideos = order(
  'aniversare-6',
  'video-1',
  'video-5',
  'aniversare-2',
