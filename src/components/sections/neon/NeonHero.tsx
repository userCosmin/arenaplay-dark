    ...
    <section className="relative flex min-h-[94vh] items-center overflow-hidden pt-28">
      ...
      <Container className="relative z-10">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <span className="mb-7 inline-flex items-center gap-2 rounded-full border border-neon-cyan/40 bg-neon-cyan/10 px-4 py-1.5 text-sm font-semibold text-neon-cyan backdrop-blur">
          ...
          <p className="mt-7 text-balance font-heading text-lg font-medium text-white/80 sm:text-xl">
